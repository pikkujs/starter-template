...
// the app would loop back to /app/auth/login. Cookies ride every request so the session
...
// our /app/auth/reset-password route, which reads the token off the query string.
//
