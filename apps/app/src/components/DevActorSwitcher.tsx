...
// Renders nothing in production or when the sandbox exposes no actors, and uses
// raw @mantine/core (plain strings) since it is a dev tool, never shipped.
export const DevActorSwitcher: FC = () => {
  ...
  return (
    <Menu position="top-end" withArrow>
      ...
      <Menu.Dropdown>
        <Menu.Label>Dev personas</Menu.Label>
        {actors.map((actor) => {
